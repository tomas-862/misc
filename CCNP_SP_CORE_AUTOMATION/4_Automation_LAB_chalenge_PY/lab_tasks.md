...
Create a script with the file name as Lab5.py that loads the config from a file on R19 and R20. Create the configuration file and save it in the /root/Scripts folder. Router username is rohit and the password is admin. The file name and configuration to be loaded are given below:
...
write mem
Create a python script called as Lab6.py in the /root/Scripts. This script must accomplish the following:
